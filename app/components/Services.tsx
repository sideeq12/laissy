...
const services = [
    {
        title: "Client Enquiry Automation",
        desc: "Automate email and website chat enquiries with safe, firm-approved responses. Always includes clear escalation paths to your team.",
            ...
            <div className="container px-4 sm:px-6 mx-auto">
                ...
                >
                    <div className="max-w-xl">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 px-2">Core <span className="text-gradient">Services</span></h2>
                        <p className="text-white/60 text-sm sm:text-base px-2">Specialized automation consulting for high-compliance professional environments.</p>
                    </div>
                    <motion.a
                        href="#contact"
